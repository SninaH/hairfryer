...
def estimate_person1():
    ...
    with open("starting_pos_ref.pkl", "rb") as f:
    ...
    while cap.isOpened():
        ...
        if not start_detected and i % 5 == 0:
            ...
            if landmarks:
                ...
                if dist < start_threshold:
                    ...
                    seq_ind = i
                    cv2.imwrite(f'outputs_examples/person1_{i-seq_ind:03d}.png', frame[PBOX_y1:PBOX_y2,PBOX_x1:PBOX_x2])
        ...
        #if 96 <= i <= 161:
        #    cv2.imwrite(f'output{i:03d}.png', frame[PBOX_y1:PBOX_y2,PBOX_x1:PBOX_x2])
